...
<table>
    ...
    <tr>
       <td>{{$empleado->nombre}}</td><td>{{$empleado->apellidos}}</td><td>{{$empleado->fechacontrato}}</td><td>{{$empleado->email}}</td><td>{{$empleado->telefono}}</td><td>{{$empleado->puestos->nombre}}</td><td>{{$empleado->departamentos->nombre}}</td><td><a href="{{url('empleado/' . $empleado->id)}}">show</a></td><td><a href="{{url('empleado/' . $empleado->id . '/edit')}}">edit</a></td><td>
